...
def jet_emulationSPOD():
	...
	# fit
	spod = SPOD_analysis.fit(X_train, nt=800)
	...
	coeffs = np.zeros([n_feature,coeffs_test_2D.shape[1]],dtype='complex')
	coeffs_tmp = np.zeros([n_freq,coeffs_test_2D.shape[1]],dtype='complex')
